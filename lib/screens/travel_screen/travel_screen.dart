...
import 'package:travel_application/bloc/auto_complete_result.dart';
import 'package:travel_application/bloc/search_places.dart';
...
import 'package:travel_application/services/map_services.dart';
...
//Markers set
  ...
  final key = 'AIzaSyAQuPOD3qYJ9eZzKPuO_XWsnMhGmcTDpsw';
...
//Initial map position on load
  static final CameraPosition _pinsk = CameraPosition(
    target: LatLng(52.111408, 26.102571),
    zoom: 12.5,
  );
  ...
  void _setCircle(LatLng point) async {
    ...
    controller
        .animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: point, zoom: 12)));
    setState(() {
      _circles.add(Circle(
  ...
  void fetchImage() async {
    if (_pageController.page !=
        null) if (allFavoritePlaces[_pageController.page!.toInt()]['photos'] != null) {
      setState(() {
  ...
  @override
  Widget build(BuildContext context) {
    final screenHeight = MediaQuery.of(context).size.height-107;
                        ...
                        children: [
                          ...
                          !pressedNear
                              ...
                              : IconButton(
                                      ...
                                      if (tokenKey != 'none') {
                                        ...
                                        placesWithin.forEach((element) {
                                          _setNearMarker(
                                            ...
                                            element['name'],
                                            element['types'],
                                            element['business_status'] ?? 'ничего не найдено',
                                          );
                                        });
                                      } else {
                                  ...
                                  icon: Icon(Icons.more_time, color: Colors.blue)),
                          IconButton(
                              onPressed: () {
                                setState(() {
                                  radiusSlider = false;
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                      width: 105.0,
                                      child: Text(
                                        tappedPlaceDetail['formatted_address'] ?? 'нет данных',
                                        style: TextStyle(
                                            fontFamily: 'WorkSans',
                                            fontSize: 11.0,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                      width: 105.0,
                                      child: Text(
                                        tappedPlaceDetail['formatted_phone_number'] ?? 'нет данных',
                                        style: TextStyle(
                                            fontFamily: 'WorkSans',
                                            fontSize: 11.0,
                                            fontWeight: FontWeight.w400),
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          color: isReviews ? Colors.green.shade300 : Colors.white),
                                      child: Text(
                                        'Отзывы',
                                        style: TextStyle(
                                  ...
                                  GestureDetector(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(11.0),
                                          color: isPhotos ? Colors.green.shade300 : Colors.white),
                                      child: Text(
                                        'Фото',
                                        style: TextStyle(
      ...
      children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(review['profile_photo_url']), fit: BoxFit.cover)),
              ),
              SizedBox(width: 4.0),
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Container(
                  ...
                  child: Text(
                    review['author_name'],
                    style: TextStyle(
                        fontFamily: 'WorkSans', fontSize: 12.0, fontWeight: FontWeight.w500),
                  ),
                ),
                SizedBox(height: 3.0),
                RatingStars(
                  ...
                  valueLabelPadding: const EdgeInsets.symmetric(vertical: 1, horizontal: 4),
        ...
        Padding(
          ...
          child: Container(
            child: Text(
              review['text'],
              style: TextStyle(fontFamily: 'WorkSans', fontSize: 11.0, fontWeight: FontWeight.w400),
            ),
          ),
        ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: photoGalleryIndex != 0 ? Colors.green.shade500 : Colors.grey.shade500),
                child: Center(
                  child: Text(
                    'Предыдущее',
                    style: TextStyle(
  ...
  gotoPlace(double lat, double lng, double endLat, double endLng, Map<String, dynamic> boundsNe,
  ...
  Future<void> moveCameraSlightly() async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(
        target: LatLng(
            allFavoritePlaces[_pageController.page!.toInt()]['geometry']['location']['lat'] +
                0.0125,
            allFavoritePlaces[_pageController.page!.toInt()]['geometry']['location']['lng'] +
                0.005),
        zoom: 14.0,
        bearing: 45.0,
        tilt: 45.0)));
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), boxShadow: [
                  BoxShadow(color: Colors.black54, offset: Offset(0.0, 4.0), blurRadius: 10.0)
                ]),
                child: Container(
                  decoration:
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          RatingStars(
                            value: allFavoritePlaces[index]['rating'].runtimeType == int
                          ...
                          Container(
                            width: 170.0,
                            child: Text(
                              allFavoritePlaces[index]['business_status'] ?? 'нет данных',
                              style: TextStyle(
                                  color:
                                      allFavoritePlaces[index]['business_status'] == 'OPERATIONAL'
                                          ? Colors.green
                                          : Colors.red,
                                  fontSize: 11.0,
